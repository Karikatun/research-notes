# Проверка результата, тестирование и безопасность

Как принимать агентный результат по наблюдаемому поведению и детерминированным проверкам.
...
- [Навык ручного security review](../tools/application-security-review.md) — применять
- [Навык appsec-fix-recommendations](../tools/appsec-fix-recommendations.md) — ограниченно
